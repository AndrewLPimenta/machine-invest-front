...
const cryptoData = {
  ...
  image: "/dot.png",
  description:
    "Polkadot é uma plataforma multichain que permite a transferência de qualquer tipo de dado ou ativo, não apenas tokens, tornando diversas blockchains interoperáveis entre si. Foi criada pela Web3 Foundation.",
  website: "https://polkadot.network",
  explorer: "https://polkascan.io",
  whitepaper: "https://polkadot.network/Polkadot-lightpaper.pdf",
  maxSupply: "1.103.303.471",
  circulatingSupply: "987.654.321",
},
  doge: {
  name: "Dogecoin",
  symbol: "DOGE",
  ...
  description:
    "Dogecoin começou como uma moeda meme baseada no popular cachorro Shiba Inu, mas ganhou tração como uma criptomoeda com uma comunidade ativa e grande aceitação online.",
  website: "https://dogecoin.com",
  explorer: "https://dogechain.info",
  whitepaper: "https://dogecoin.com/dogepaper/",
  maxSupply: "Ilimitado",
  circulatingSupply: "143.234.123.000",
},
  avax: {
  name: "Avalanche",
  symbol: "AVAX",
  ...
  description:
    "Avalanche é uma plataforma blockchain altamente escalável e de alta performance, projetada para aplicações descentralizadas e personalizadas, com confirmação de transações quase instantânea.",
  website: "https://avax.network",
  explorer: "https://snowtrace.io",
  whitepaper: "https://www.avalabs.org/whitepapers",
  maxSupply: "720.000.000",
  circulatingSupply: "377.752.194",
},
link: {
    name: "Chainlink",
    symbol: "LINK",
    ...
    description:
      "Chainlink é uma rede descentralizada de oráculos que permite que contratos inteligentes na blockchain se conectem com dados do mundo real de maneira segura e confiável. Ela fornece infraestrutura crítica para aplicações DeFi e outros serviços que dependem de dados externos.",
...
ltc: { 
    ...
    image: "/litecoin.png",
    description:
      "Litecoin é uma criptomoeda peer-to-peer criada em 2011 por Charlie Lee. Baseada no código do Bitcoin, ela oferece confirmações mais rápidas e uma abordagem eficiente para pagamentos digitais.",
    website: "https://litecoin.org",
    explorer: "https://blockchair.com/litecoin",
    whitepaper: "https://litecoin.org/light-paper.pdf",
    maxSupply: "84.000.000",
    circulatingSupply: "74.000.000",
},
etc: { 
    ...
    image:  "/etc.png",
    description:
      "Ethereum Classic é uma plataforma de contratos inteligentes que mantém a filosofia original da Ethereum antes do hard fork que criou a rede Ethereum atual. É uma blockchain descentralizada que permite execução de contratos imutáveis.",
    website: "https://ethereumclassic.org",
    explorer: "https://etcblockexplorer.com",
    whitepaper: "https://ethereumclassic.org/whitepaper",
    maxSupply: "210.700.000",
    circulatingSupply: "143.000.000",
},
uni: { 
    name: "Uniswap",
    symbol: "UNI",
    ...
    image: "/uniswap.png",
    description:
      "Uniswap é um protocolo de troca descentralizada (DEX) baseado na rede Ethereum, permitindo que usuários realizem swaps de tokens ERC-20 sem intermediários, utilizando pools de liquidez.",
...
atom: { 
    ...
    image: "/atom.png",
    description:
      "Cosmos é uma rede descentralizada que visa criar um ecossistema de blockchains interconectadas, permitindo a comunicação entre diferentes redes através do protocolo IBC (Inter-Blockchain Communication).",
    website: "https://cosmos.network",
    explorer: "https://www.mintscan.io/cosmos",
    whitepaper: "https://cosmos.network/resources/whitepaper",
    maxSupply: "Não possui limite fixo",
    circulatingSupply: "390.000.000",
},
apt: { 
    name: "Aptos",
    symbol: "APT",
    ...
    description:
      "Aptos é uma blockchain de alta performance focada em escalabilidade e segurança, construída por ex-membros da equipe do projeto Diem (Meta). Utiliza a linguagem Move para contratos inteligentes.",
    website: "https://aptosfoundation.org",
    explorer: "https://explorer.aptoslabs.com",
    whitepaper: "https://aptos.dev/whitepaper",
    maxSupply: "1.000.000.000",
...
near: { 
    ...
    image: "/near.png",
    description:
      "NEAR Protocol é uma plataforma de blockchain focada em usabilidade, escalabilidade e desempenho, oferecendo contratos inteligentes e suporte a aplicações descentralizadas (dApps) com baixas taxas.",
    website: "https://near.org",
    explorer: "https://explorer.near.org",
    whitepaper: "https://near.org/papers/the-official-near-white-paper",
    maxSupply: "1.000.000.000",
    circulatingSupply: "1.020.000.000", 
},
xlm: { 
    name: "Stellar",
    symbol: "XLM",
    ...
    image: "/stellar.png",
    description:
      "Stellar é uma rede de pagamento descentralizada que conecta bancos, sistemas de pagamento e pessoas, permitindo transferências rápidas e de baixo custo em qualquer moeda.",
    website: "https://stellar.org",
    explorer: "https://stellar.expert",
    whitepaper: "https://www.stellar.org/papers/stellar-consensus-protocol.pdf",
    maxSupply: "50.001.806.812",
    circulatingSupply: "28.000.000.000",
},
trx: { 
    name: "TRON",
    symbol: "TRX",
    ...
    image: "/tron.png",
    description:
      "TRON é uma plataforma blockchain descentralizada focada na criação e distribuição de conteúdo digital e aplicações descentralizadas, oferecendo alta velocidade e baixas taxas.",
    website: "https://tron.network",
    explorer: "https://tronscan.org",
    whitepaper: "https://developers.tron.network/docs/whitepaper",
    maxSupply: "Não possui limite fixo",
...
shib: { 
    ...
    image: "/shiba-inu.png",
    description:
      "Shiba Inu é uma criptomoeda meme inspirada no Dogecoin, criada para a comunidade e como um experimento em construção de ecossistemas descentralizados, incluindo tokens e NFTs.",
    website: "https://www.shibatoken.com",
    explorer: "https://etherscan.io/token/0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE",
    whitepaper: "https://www.shibatoken.com/shiba-inu-whitepaper.pdf",
