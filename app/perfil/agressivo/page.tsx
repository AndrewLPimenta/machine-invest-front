        ...
        <div className="min-h-screen bg-background">
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
              ...
              <CardContent>
                ...
                <div className="flex justify-center mt-4">
                  <Button size="sm" asChild>
                    <Link href="/perfil/agressivo/criptomoeda">Ver todas as principais</Link>
                  </Button>
                </div>
              </CardContent>
            ...
            <Card className="bg-background/50 border backdrop-blur-lg shadow-lg border-primary/20">
              <CardHeader>
                <CardTitle className="text-3xl font-bold">
                  Investimentos Seguros com IA
                </CardTitle>
                <CardDescription className="mt-2 text-sm text-muted-foreground">
                  Receba recomendações personalizadas para proteger seu patrimônio e reduzir riscos.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col md:flex-row gap-4 mt-4">
                  <div className="flex-1 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                    <h4 className="font-semibold text-blue-600 mb-2">Gestão de Riscos</h4>
                    <p className="text-sm text-muted-foreground">
                      Identifique riscos e proteja seus investimentos mesmo em momentos de volatilidade.
                    </p>
                  </div>
                  <div className="flex-1 p-4 bg-purple-50 dark:bg-purple-950/20 rounded-lg">
                    <h4 className="font-semibold text-purple-600 mb-2">Minimizar Perdas</h4>
                    <p className="text-sm text-muted-foreground">
                      Receba alertas e estratégias que ajudam a reduzir perdas em sua carteira.
                    </p>
                  </div>
                  <div className="flex-1 p-4 bg-green-50 dark:bg-green-950/20 rounded-lg">
                    <h4 className="font-semibold text-green-600 mb-2">Planejamento Inteligente</h4>
                    <p className="text-sm text-muted-foreground">
                      Defina metas conservadoras e acompanhe a performance com recomendações contínuas da IA.
                    </p>
                  </div>
                </div>
                <div className="mt-4 flex py-6 justify-center">
                  <Button size="lg" asChild className="bg-primary text-background hover:bg-primary/90">
                    <Link href="/perfil/conservador/chatbot">Conversar agora</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent>
              ...
              <Button variant="outline" className="w-full mt-6 bg-primary text-background" disabled>
                Em breve.
              </Button>
            </CardContent>
                  ...
                  {marketOpportunities.map((opportunity, index) => (
                    ...
                    >
                      ...
                      <CardContent className="space-y-6">
                        ...
                        <Button
                          className="w-full transition-colors text-base py-3"
                          size="lg"
                        >
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <Card
                      key={i}
                      className={`relative overflow-hidden group hover:shadow-lg transition-all duration-300 ${insight.urgency === "high" ? "border-l-4 border-l-chart-4" : "border-l-4 border-l-chart-2"
                        }`}
                    >
                      ...
                      <CardContent className="pt-0">
                        <Button
                          variant="outline"
                          className="bg-primary/10 text-primary whitespace-nowrap border-0"
                        >
                          {insight.action}
