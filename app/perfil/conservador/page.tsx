    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="text-center space-y-2 sm:space-y-4">
        ...
        <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-4">
          Estratégias de investimento focadas em segurança e preservação do capital, com baixo risco e rentabilidade
          estável.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Distribuição ideal para o perfil conservador</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Investimentos ideais para o perfil conservador</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Veja quanto seu dinheiro pode render com investimentos seguros</CardDescription>
        </CardHeader>
        <CardContent>
