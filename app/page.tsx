...
export default function ComparativoPage() {
  ...
  return (
    <PageLayout>
      <Section>
        <SectionHeading
          title="Machine Invest vs <span class='text-muted-foreground'>Bancos Tradicionais</span>"
        ...
        >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 border-l-4 border-primary pl-4">
                <p className="italic">
                  "A diferença na experiência do usuário é impressionante. Tudo é mais simples, rápido e transparente na
                  Machine Invest."
                </p>
              ...
              <div className="space-y-2 border-l-4 border-primary pl-4">
                <p className="italic">
                  "A possibilidade de investir em criptomoedas de forma segura e integrada com meus outros investimentos
                  foi o que me fez escolher a Machine Invest."
                </p>
